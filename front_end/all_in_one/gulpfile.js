...
gulp.task("sass", ['scsslint'], function(){   //所有数组中的任务都会在sass之前执行
...
gulp.task('copy', function(){   //将静态资源 图片，字体等不需要处理的文件复制到dist线上目录
	gulp.src('app/assets/**/*').pipe(gulp.dest("dist/assets/"));
});

gulp.task("convertjs", ['sass'], function(){
...
gulp.task("browser", ['copy','convertjs'], function(){
	gulp.watch("./app/css/**/*.scss", reload);
